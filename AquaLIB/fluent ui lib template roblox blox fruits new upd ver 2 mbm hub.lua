...
--------------------------------------------------------------------------------------------------------------------------------------------
--Create Tabs
local listfastattack = {'1','0.15','0.1','0 (Risk)','0.5','0.2','0.05'}
	...
	elseif _G.FastAttackFaiFao_Mode == "0.2" then
        _G.Fast_Delay = 0.25
    elseif _G.FastAttackFaiFao_Mode == "0.1" then
		_G.Fast_Delay = 0.1
...
--------------------------------------------------------------------------------------------------------------------------------------------
    Tabs.Main:AddButton({
        Title = "Auto Chest",
        Description = "risk (may bug)",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/m1M-Plqer819/roblox/main/CCCh"))()
        end
    })
----------------------------------------------------------------------------------------------------------------------------------------------
      Tabs.Main:AddButton({
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Teleport To Mirage Island", Default = false })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("need go to sea 3 to open all function")
end
